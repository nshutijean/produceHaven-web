        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <div class="row">
                        <div class="col-md-3 product-box mr-3" v-for="(order, index) in orders" v-bind:key="index">
                            <img :src="order.product.image" :alt="order.product.name" class="img-fluid rounded">
                            <h5>
                                <span v-html="order.product.name"></span><br>
                                <span class="small-text text-muted">RF {{order.product.price}}</span>
                            </h5>
                            <hr>
                            ...
                            <br><br>
                            <p><strong>Delivery address:</strong><br> {{order.address || "Not specified"}}</p>
                        </div>
                    </div>
                </div>
            </div>
