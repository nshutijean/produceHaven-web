<template>
  <div class="col-lg-12 col-md-8">
    <div>
      ...
      >
        <p>List of orders made in this store</p>
      </div>
    </div>
  ...
  methods: {
    ...
    shipIt() {
      ...
      Swal.fire({
        ...
        icon: "info",
        html: "<em><i>Deliver with Biras Delivery</i></em>",
        showCloseButton: true,
        showCancelButton: true,
        focusConfirm: false,
        confirmButtonText: `<a target="_blank" href="https://api.whatsapp.com/send?phone=+250780679487&text=${message}" style="color:white"><i class="fa fa-thumbs-up"></i></a>`,
    ...
    getBuyerInfo(buyer_id) {
      axios.get(`/api/users/${buyer_id}`).then((response) => {
